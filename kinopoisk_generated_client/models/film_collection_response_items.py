...
class FilmCollectionResponseItems:
    """ 
        Attributes:
            ...
            type_ (FilmCollectionResponseItemsType | Unset):  Example: FILM.
    ...
    type_: FilmCollectionResponseItemsType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: FilmCollectionResponseItemsType | Unset
        if isinstance(_type_,  Unset):
            type_ = UNSET
        else:
            type_ = FilmCollectionResponseItemsType(_type_)
