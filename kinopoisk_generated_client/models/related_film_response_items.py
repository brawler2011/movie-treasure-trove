...
class RelatedFilmResponseItems:
    """ 
        Attributes:
            kinopoisk_id (int | Unset):  Example: 301.
            ...
            relation_type (RelatedFilmResponseItemsRelationType | Unset):  Example: SIMILAR.
     """
    ...
    relation_type: RelatedFilmResponseItemsRelationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        relation_type: RelatedFilmResponseItemsRelationType | Unset
